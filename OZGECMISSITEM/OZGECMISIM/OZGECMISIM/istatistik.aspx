<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="istatistik.aspx.cs" Inherits="OZGECMISIM.istatistik" %>
...
<div class="list_of_members" style="margin-left:450px">
   <a href="Yeteneklerim.aspx"><div class="sales">
        <div class="icon">
    ...
    <a href="Iletisim.aspx"><div class="new-users">
       <div class="icon">
           
        </div>
        <div class="icon-text">
            <h3><asp:Label ID="Label2" runat="server" Text="Label"></asp:Label></h3>
            <p>Toplam Gelen Mesaj Sayısı</p>
        </div>
        <div class="clearfix"></div>
    </div></a>
...
<div class="total-world">
    ...
    <div class="site-report">
        ...
        <p>Özgeçmiş sitesinin admin paneline hoşgeldin.</p>
    </div>
    <div class="clearfix"></div>
</div>
